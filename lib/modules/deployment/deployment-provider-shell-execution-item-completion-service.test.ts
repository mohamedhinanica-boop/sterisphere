...
async function scenarioProviderTargetStateMismatch() { return expectIssue("provider target-state mismatch", snapshot({ item: { targetState: { deploymentProviderKey: PROVIDER_SHELL_EXECUTION_ITEM_COMPLETION_TEST_IDS.providerKey, provisioningSource: "setup_draft", provisioningStatus: "placeholder", active: true } }, itemPatches: { 2: { targetState: { deploymentProviderKey: PROVIDER_SHELL_EXECUTION_ITEM_COMPLETION_TEST_IDS.providerKey, provisioningSource: "setup_draft", provisioningStatus: "placeholder", active: true } } } }), "provider_target_state_mismatch", "blocked"); }
